...
<form action="" method="POST" id="profileForm">
    <input type="hidden" name="id" value="<?= htmlspecialchars($data['student']->getId()) ?>" id="studentIdHidden"/>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div class="admin-card bg-white p-6">
            ...
            <input
                value="<?= htmlspecialchars($data['student']->getId()) ?>"
        ...
        <div class="admin-card bg-white p-6">
            ...
            <input
                name="name"
                value="<?= htmlspecialchars($data['student']->getName()) ?>"
        ...
        <div class="admin-card bg-white p-6">
            ...
            <input
                name="email"
                value="<?= htmlspecialchars($data['student']->getEmail()) ?>"
        ...
        <div class="admin-card bg-white p-6 md:col-span-2">
            ...
            <select
                ...
                id="roleSelect"
            >
                <option value="<?= htmlspecialchars($data['student']->getRole()) ?>" selected>
                    <?= htmlspecialchars($data['student']->getRole()) ?>
                </option>
            </select>
            <p class="text-[10px] text-gray-400 font-semibold italic mt-2">
